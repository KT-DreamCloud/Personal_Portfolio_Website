...
// Every personal project below is still hosted on the previous portfolio. That
// site switches sections with JS click handlers and ignores the URL hash, so
// this has to point at the root — visitors pick My Projects from its side nav.
export const oldPortfolio = {
  url: 'https://karan-personal-portfolio-site.netlify.app/',
  label: 'Old Portfolio',
};

// Major work. Same shape as personalProjects below, plus optional role, period
// and points fields that only the bigger builds tend to need.
export const majorProjects = [
  {
    title: 'Aktivate AI Automation Tool',
    emoji: '\u{1F916}',
    role: 'Lead Developer',
    ...
    description:
      'A full-stack automation workbench built with Cursor AI, FastAPI and Oracle for test data retrieval, enabling one-click test execution for customer activation by streamlining lengthy multi-step REST API flows.',
    points: [
      'Orchestrates customer activation end to end \u2014 add-line for existing customers, price plan changes, payment processing and verification \u2014 across live non-production environments (DEV/TEST/PERF) using Oracle-backed test data.',
      'Leverages Generative AI and prompt-driven engineering to enhance feature delivery and automate manual workflows, cutting repetitive end-to-end activation testing from 20 minutes to 1 minute and boosting team productivity.',
      'Runs a 6-step activation process across 5+ REST microservices, covering 4 device modes, 1\u20139 multi-line activations, 12 price plans and 4 add-ons with automatic payload generation and catalog-driven changes.',
      'Integrates Oracle DB for unused SIM/IMEI provisioning, subscriber lookup and post-activation processes.',
    ],
    live: 'https://aktivate-automation-tool.netlify.app/',
    repo: '',
    youtube: '',
  },
  {
    ...
    role: 'Lead Developer',
    period: 'Jul 2026 \u2013 Aug 2026',
    tags: ['React', 'TypeScript', 'Vite', 'Swagger UI', 'OpenAPI', 'YAML', 'Cursor AI'],
    description:
      'A clone of the Swagger Editor built in a 6-hour timeframe. A live editor\u2013preview split view lets developers read and navigate REST API endpoints without the overhead of switching between multiple YAML files.',
    points: [
      'Scrollable multi-tabs open and manage many YAML specs at once, auto-classifying them into two categories \u2014 Frontend Swaggers and Backend Swaggers (CSM).',
      'Retains up to 40 recently viewed documents so any spec can be reopened instantly.',
      'Used Cursor AI and prompt-driven engineering to accelerate the UI architecture and the editor\u2013preview sync.',
    ],
    live: 'https://schamanav2.netlify.app/',
    repo: '',
    youtube: '',
  },
];
...
export const certifications = [
  {
    title: 'GenAI Hero',
    issuer: 'AT&T Consumer Classic, Cricket & SaaS',
    featured: true,
    badge: 'Featured recognition',
    image: '/certificates/genai-hero.png',
    highlight: 'Featured at AT&T\u2019s quarterly townhall \u2728',
    points: [
      'Recognized as one of the most active and consistent developers using Generative AI (GenAI \u{1F916}) for outstanding development tasks.',
      'Used GenAI for code generation, production optimization and faster issue resolution \u2014 improving code quality, deployment efficiency and bug-free coding.',
      'Significantly enhanced overall development velocity and team productivity, likely making me one of the youngest employees to receive this recognition.',
    ],
    description:
      'Certificate of Recognition for outstanding contributions to the Transformer scrum team, driven by daily use of Generative AI tooling across documentation, code generation and issue resolution.',
    tags: ['GenAI', 'Copilot', 'Tabnine', 'AT&T'],
  },
  {
